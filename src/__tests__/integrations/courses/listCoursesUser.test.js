...
describe('Testando rota de listagem de usuários de um curso', () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const couse = yield (0, loadData_1.createCoursesData)(database_1.client);
    ...
    it('GET /courses/:id/users - Sucesso: Listando cursos do usuário com token de admin.', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('GET /courses/:id/users - Erro: Listando cursos do usuário com token de não admin.', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .get(`/courses/${courseHTML.id}/users`)
    ...
    it('GET /courses/:id/users - Erro: Listandos todos os cursos sem enviar token.', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default).get(`/courses/${courseHTML.id}/users`);
        expect(response.status).toBe(401);
        expect(response.body).toHaveProperty('message');
        expect(response.body.message).toBe('Missing bearer token');
    }));
    it('GET /courses/:id/users - Erro: Listandos todos os cursos enviando token errado.', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default)
            .get('/users')
