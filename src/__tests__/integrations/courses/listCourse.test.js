...
describe("Testando rota de listagem de cursos", () => {
    ...
    it("GET /courses - Sucesso: Listando todos os cursos.", () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(app_1.default).get("/courses");
